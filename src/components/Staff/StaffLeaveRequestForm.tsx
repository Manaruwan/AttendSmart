...
const StaffLeaveRequestForm: React.FC<{ onViewHistory?: () => void }> = ({ onViewHistory }) => {
  ...
  useEffect(() => {
    console.log('🔄 Form useEffect triggered, firebaseUser:', firebaseUser);
    
    if (firebaseUser) {
      const userName = firebaseUser.displayName || firebaseUser.email?.split('@')[0] || '';
      const userEmail = firebaseUser.email || '';
      
      console.log('👤 Firebase user detected:', { userName, userEmail });
      ...
      console.log('🎭 Using demo data for staff form');
      setFormData(prev => ({
        ...prev,
        fullName: 'John Staff (Demo)',
        email: 'staff.demo@university.edu'
      }));
    }
  }, [firebaseUser]);

  // Leave types for staff
  const leaveTypes = [
    'Annual Leave',
    'Sick Leave',
    'Emergency Leave',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('📊 Submitting staff leave request:', leaveRequest);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Staff Leave Request Form</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      placeholder="e.g., Administrative Assistant, IT Technician"
                      required
                    />
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                ...
                <ul className="text-sm text-yellow-700 space-y-2">
                  ...
                  <li>• Contact your supervisor before submitting</li>
                </ul>
              </div>
